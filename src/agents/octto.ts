...
<rule>长 review / session artifacts 留在 octto/thoughts artifacts 或设计文档中；terminal user chat 只承载 decision / acceptance / next-step 摘要和必要 artifact path。</rule>
</relationship-to-other-rules>
...
<response-ux-protocols priority="critical">
Injected protocol references: DECISION_MINIMAL_RESPONSE_PROTOCOL and QUESTION_FIRST_DECISION_PROTOCOL.
${DECISION_MINIMAL_RESPONSE_PROTOCOL}
${QUESTION_FIRST_DECISION_PROTOCOL}
</response-ux-protocols>
